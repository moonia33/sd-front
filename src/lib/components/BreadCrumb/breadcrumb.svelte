...
<div class="relative mb-8 overflow-hidden bg-white pt-4 dark:bg-black">
	<svg
		class="absolute inset-s-1/2 -bottom-20 w-475 -translate-x-1/2 transform"
		width="2745"
		height="488"
				...
				<ol class="flex items-center whitespace-nowrap">
					{#each items as item, index (item.label)}
						<li class="inline-flex items-center">
							...
							{:else}
								<span
									class="inline-flex items-center truncate text-sm font-semibold text-gray-800 dark:text-neutral-200"
							...
							{#if index !== items.length - 1}
								<svg
									class="mx-2 size-5 shrink-0 text-gray-400 dark:text-neutral-500"
									width="16"
									height="16"
									viewBox="0 0 16 16"
									fill="none"
