...
<footer class="mx-auto mt-auto w-full max-w-340 px-4 py-10 sm:px-6 lg:px-8">
	...
	<div class="mb-10 grid grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-4">
		<div class="col-span-full hidden lg:col-span-1 lg:block">
			<a
				class="flex-none text-xl font-semibold text-gray-800 focus:opacity-80 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-current dark:text-neutral-200"
				href={resolve('/')}
			...
			{#if site?.contact_email || site?.contact_phone}
				<div class="mt-4 grid gap-2 text-sm">
					{#if site?.contact_email}
						<a
							class="text-gray-600 hover:text-gray-800 focus:text-gray-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-current dark:text-neutral-300 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
